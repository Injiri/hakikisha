...
public class ActivityAccountTypeSelect extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        proceedView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isBuyer){
                    HakikishaPreference.setAccountTypePref(ActivityAccountTypeSelect.this, Constants.SELLER_ACCOUNT_TYPE);
                } else {
                    HakikishaPreference.setAccountTypePref(ActivityAccountTypeSelect.this,Constants.CUSTOMER_ACCOUNT_TYPE);
                }

                Intent intent = new Intent(ActivityAccountTypeSelect.this, LoginActivity.class);

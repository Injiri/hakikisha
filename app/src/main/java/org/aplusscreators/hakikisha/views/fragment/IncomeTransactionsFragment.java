...
public class IncomeTransactionsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_income_transactions_layout,container,false);
    ...
    private void initializeResources(View view) {
        this.orderRecyclerView = view.findViewById(R.id.income_recycler_view);
